...
public class LobbyLANGame : MonoBehaviour {
    ...
    {
        joinLANGameAction = (connectionInfo) => { ResolveJoinGame(connectionInfo); };
    }
    ...
    private void AddEventListeners()
    {
        ...
        uiManager.GetComponent<NewLANGameWindow>().OnCreateNewLANGame.AddListener(joinLANGameAction);
    ...
    private void ResolveJoinGame(LANConnectionInfo connectionInfo)
    {
        //open the window
        OpenWindow();
    }
    ...
    private void RemoveAllListeners()
    {
        ...
        if(uiManager != null)
        {
            ...
            uiManager.GetComponent<NewLANGameWindow>().OnCreateNewLANGame.RemoveListener(joinLANGameAction);
        }
